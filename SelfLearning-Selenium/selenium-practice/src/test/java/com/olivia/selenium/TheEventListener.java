...
public class TheEventListener implements WebDriverEventListener {
	...
	public void beforeNavigateTo(String url, WebDriver driver) {
		System.out.println("Before navigation, current url is: " + driver.getCurrentUrl());
	...
	public void afterNavigateTo(String url, WebDriver driver) {
		...
		System.out.println("The page load time is: " + (loadEventEnd - navigationStart)/1000 + " seconds");
